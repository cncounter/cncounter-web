...
public class MethodInfo {
    ...
    public byte[] nameIndex; //         u2; 方法名对应的常量索引位置
    ...
    public String toString() {
        return "MethodInfo{" +
                "accessFlagsNumber=" + accessFlagsNumber +
                ", nameIndexNumber=" + nameIndexNumber +
                ", descriptorIndexNumber=" + descriptorIndexNumber +
                ", attributesCountNumber=" + attributesCountNumber +
